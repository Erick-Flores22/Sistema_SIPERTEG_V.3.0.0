    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white shadow sm:rounded-lg p-6">
                <form action="{{ route('abonados.update', $abonado) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre"
                                   value="{{ old('nombre', $abonado->nombre) }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="apellido" id="apellido"
                                   value="{{ old('apellido', $abonado->apellido) }}"
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"
                                   required>
                            @error('apellido')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <input type="text" name="telefono1" id="telefono1"
                                   value="{{ old('telefono1', $abonado->telefono1) }}"
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"
                                   required>
                            @error('telefono1')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <input type="text" name="telefono2" id="telefono2"
                                   value="{{ old('telefono2', $abonado->telefono2) }}"
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            @error('telefono2')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <input type="text" name="numero_casa" id="numero_casa"
                                   value="{{ old('numero_casa', $abonado->numero_casa) }}"
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm"
                                   required>
                            @error('numero_casa')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                        ...
                        <div>
                            ...
                            <input type="date" name="fecha_corte" id="fecha_corte"
                                   value="{{ old('fecha_corte', $abonado->fecha_corte?->format('Y-m-d')) }}"
                                   class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            @error('fecha_corte')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        ...
                        <div>
                            ...
                            <select name="estado" id="estado"
                                    class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                                <option value="activo"   {{ old('estado', $abonado->estado)=='activo'   ? 'selected' : '' }}>Activo</option>
                                <option value="inactivo" {{ old('estado', $abonado->estado)=='inactivo' ? 'selected' : '' }}>Inactivo</option>
                            </select>
                            @error('estado')
                                <p class="text-red-600 text-sm mt-1">{{ $message }}</p>
                            @enderror
